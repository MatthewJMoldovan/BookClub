...
<body>
	<nav
		...
		<h1 class="navbar-brand mb-0 fs-1">Welcome, ${userName }</h1>
		<div>
	...
	<div class="w-75 p-4 mx-auto rounded border text-bg-dark">
		...
		<h3>Add a book to your book shelf!</h3>
			<form:form action="/process/createBook" method="POST"
				...
				<div class="formGroup">
					...
					<div>
						<form:hidden path="postedBy" value="${userId}"></form:hidden>
					</div>
